package com.gloddy.batch.config.dynamodb
...
@Configuration
@EnableDynamoDBRepositories(basePackages = ["com.gloddy.batch.model.dynamodb"], dynamoDBMapperConfigRef = "dynamoDBMapperConfig")
